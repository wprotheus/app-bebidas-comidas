...
public class MainActivity extends AppCompatActivity
{
    ...
    {
        if(boxB1.isChecked()) pessoa.setBebidas(boxB1.getText().toString());
        if(boxB2.isChecked()) pessoa.setBebidas(boxB2.getText().toString());
        if(boxB3.isChecked()) pessoa.setBebidas(boxB3.getText().toString());
        if(boxB4.isChecked()) pessoa.setBebidas(boxB4.getText().toString());
        if(boxB5.isChecked()) pessoa.setBebidas(boxB5.getText().toString());

git
    if(boxC1.isChecked()) pessoa.setComidas(boxC1.getText().toString());
        if(boxC2.isChecked()) pessoa.setComidas(boxC2.getText().toString());
        if(boxC3.isChecked()) pessoa.setComidas(boxC3.getText().toString());
        if(boxC4.isChecked()) pessoa.setComidas(boxC4.getText().toString());
        if(boxC5.isChecked()) pessoa.setComidas(boxC5.getText().toString());
    }
}